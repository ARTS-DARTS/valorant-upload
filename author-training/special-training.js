const configs = {
  combo: {
    ...
    recording: ['Показаны агенты, их позиции и роли', 'Полностью показана первая способность', 'Виден тайминг запуска второй способности', 'Показан общий результат связки'],
  ...
  wallbang: {
    ...
    recording: ['Показаны оружие и исходная позиция', 'Хорошо видны поверхность и точка прицела', 'Сам выстрел показан без монтажного разрыва', 'Видны попадание и нанесённый урон'],
