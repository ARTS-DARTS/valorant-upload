const configs = {
  combo: {
    ...
    recording: ['Видео записано строго в 1920×1080 (Full HD), 60 FPS, H.264 — не 30 и не 120 FPS', 'Качество графики в игре — минимум «Среднее»', 'Показаны агенты, их позиции и роли', 'Полностью показана первая способность', 'Виден тайминг запуска второй способности', 'Показан общий результат связки'],
  ...
  wallbang: {
    ...
    recording: ['Видео записано строго в 1920×1080 (Full HD), 60 FPS, H.264 — не 30 и не 120 FPS', 'Качество графики в игре — минимум «Среднее»', 'Показаны оружие и исходная позиция', 'Хорошо видны поверхность и точка прицела', 'Сам выстрел показан без монтажного разрыва', 'Видны попадание и нанесённый урон'],
